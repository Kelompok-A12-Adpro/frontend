...
const mockCampaignDetail = {
  ...
  description:
    "Penggalangan dana ini bertujuan untuk mendukung kebutuhan dasar anak yatim piatu di panti asuhan Kasih Bunda. Dana akan digunakan untuk biaya sekolah, makanan bergizi, dan pakaian layak.",
...
export default function CampaignDetailPage({
  ...
  const campaign =
    campaignId === mockCampaignDetail.id ? mockCampaignDetail : null;
  ...
  const handleDonateSubmit = (amount: number, message: string | null) => {
    ...
    alert(
      `Donation submitted (simulated): Amount ${amount}, Message: "${message || ""}"`,
    );
  };
            ...
            <div className="mb-4">
              ...
              <div className="w-full bg-gray-300 rounded-full h-2.5 mt-2">
                <div
                  ...
                  style={{
                    width: `${(campaign.currentAmount / campaign.goal) * 100}%`,
                  }}
                ></div>
              </div>
            </div>
